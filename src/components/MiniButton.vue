...
<template>
  <section class="bg-autumn-texture bg-cover w-full h-screen min-h-screen fixed inset-0 grid place-items-center z-50 bg-[#00674f]" id="opening">
      <div class="w-6/12 text-center text-xs md:text-lg lg:text-xl">
        <div class="mt-5 animate__animated animate__zoomInUp">
          ...
          <p class="font-medium text-white">Minggu, 20 April 2025</p>
          <button type="buton" class="w-10/12 md:w-8/12 text-sm md-text-lg mt-6 font-medium z-50 border border-amber-800 text-gray-100 bg-green-300 p-2 rounded-full pointer active:scale-90 hover:bg-amber-500 hover:text-gray-100 duration-300" @click="openInvitation">
