...
<template>
  <section class="bg-autumn-texture bg-cover w-full h-screen min-h-screen fixed inset-0 grid place-items-center z-50 bg-gray-500" id="opening">
      <div class="w-6/12 text-center text-xs md:text-lg lg:text-xl">
        <div class="mt-5 animate__animated animate__zoomInUp">
          <h1 class="kalam-font font-semibold text-5xl lg:text-6xl my-5 text-black">Niah &amp; Jamal</h1>
          <p class="kalam-font text-black font-medium text-lg">We Are Getting Married</p>
          <p class="font-medium text-black">Sabtu, 06 Juli 2024</p>
          <button type="buton" class="w-10/12 md:w-8/12 text-sm md-text-lg mt-6 font-medium z-50 border border-amber-800 text-gray-100 bg-black p-2 rounded-full pointer active:scale-90 hover:bg-amber-500 hover:text-gray-100 duration-300" @click="openInvitation">
            <i class="fa-solid fa-book-open mr-1" ></i> Buka undangan </button>
        </div>
      </div>
  </section>
  <audio ref="audioEl" autoplay>
    <source src="@/assets/audio/cinta-terakhir-arilasso.mp3" type="audio/mp3">
  </audio>
