...
<template>
  <section class="w-full bg-gradient-to-b from-green-300 to-[#00674f]">
    <section class="container-section pb-12">
      ...
      <Card>
        <template v-slot:body>
          <div class="bg-[#00674f] px-6 py-8 text-center text-sm font-medium" v-for="(timeline, index) in timelines" :key="index">
